...
module.exports = class Charts extends StyleBaseView
  el: '#container'
  template: JST['admin/style_guide/charts']

  events:
    'click li' : 'toogleChart'

  initialize: ->
    @chart_width = 940
    @calcultePercents()
    $('li.style_guide_charts').addClass('active')
  ...
  toogleChart: (event) =>
    ...
    $('#chart').fadeOut 'slow', =>
      chartName = chart_name.charAt(0).toUpperCase() + chart_name.slice(1)
      $('#chart').empty()
      @['show'+chartName]()
      $('#chart').fadeIn()
