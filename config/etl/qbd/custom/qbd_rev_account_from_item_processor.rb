module ETL
  module Processor
    # Public: ETL Row Processor to look up revenue account from qbd_item
    #
    # This processor is used by jobs that load revenue facts, such as 
    #   qbd_invoices. The processor is essentially a hierarchy of sources
    ...
    #   future lookups
    #
    class QbdRevAccountFromItemProcessor < ETL::Processor::RowProcessor
