...
@existing_where = {company_id: @company_id, source: 'qbd_vendor_credit'}
...
after_read  :qbd_exp_account_from_item, {:posting_type => :credit}
after_read	:qbd_accounts, {
	:credit_account => :exp_account_id,
	:debit_account => "APAccountId"
}
