    ...
    function JScrollPane(elem, s) {
        ...
        if (isScrollableV) {
          ...
          container.append(
              $('<div class="jspVerticalBar" />').append(
                  $('<div class="jspCap jspCapTop" />'), $('<div class="jspTrack" />').append(
                      $('<div class="jspDrag" />').append(
                          $('<div class="jspDragTop" />'), $('<div class="jspDragBottom" />'))), $('<div class="jspCap jspCapBottom" />')));
        ...
        if (isScrollableH) {
          ...
          container.append(
              $('<div class="jspHorizontalBar" />').append(
                  $('<div class="jspCap jspCapLeft" />'), $('<div class="jspTrack" />').append(
                      $('<div class="jspDrag" />').append(
                          $('<div class="jspDragLeft" />'), $('<div class="jspDragRight" />'))), $('<div class="jspCap jspCapRight" />')));
      ...
      function initMousewheel() {
        container.unbind(mwEvent).bind(
            mwEvent, function(event, delta, deltaX, deltaY) {
      ...
      function hijackInternalLinks() {
        ...
        $(document.body).delegate('a[href*=#]', 'click', function(event) {
          ...
          var href = this.href.substr(0, this.href.indexOf('#')),
              ...
              hash, element, container, jsp, scrollTop, elementTop;
